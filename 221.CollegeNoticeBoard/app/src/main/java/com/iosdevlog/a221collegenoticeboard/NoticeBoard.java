...
public class NoticeBoard extends Activity {
    private static final int GET_OUT_COUNT_FINISH = 1;
    private static final int SHOW_PREVIOUS_MSG = 2;
    private static final int DB_USER_DATA = 3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Get values from DB..
        new Thread(getOutCountRunnable).start();
    }

    private void created() {
        new Thread(dbUserDataRunnable).start();
    }

    private void dbUserDataFinish() {
        ...
        for (int i = 0; i < Int_MsgCount; i++) {
            ...
            // TODO: android.os.NetworkOnMainThreadException
            ...
            LayoutParams param_TextUser = new LayoutParams
            ...
            LayoutParams param_Text_Date = new LayoutParams
                    (LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
            ...
            LayoutParams param_Text_UserId = new LayoutParams
            ...
            LayoutParams params_line = new LayoutParams
    ...
    public void Update_Msg() {
        ...
        But_NewMsg = new Button(NoticeBoard.this);
    ...
    public void DB_Show_Previous_Msg() {
        ...
        try {
            ...
            for (int i = 0; i < jarray.length(); i++) {
                ...
                handler.sendEmptyMessage(SHOW_PREVIOUS_MSG);
            }
        } catch (Exception e) {
            Log.e("DB_Get_Out_Count", e.toString());
        }
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            //处理UI
            switch (msg.what) {
                case GET_OUT_COUNT_FINISH:
                    created();
                    break;
                case SHOW_PREVIOUS_MSG:
                    updateUI();
                    break;
                case DB_USER_DATA:
                    dbUserDataFinish();
    ...
    Runnable getOutCountRunnable = new Runnable() {
        @Override
        public void run() {
            DB_Get_Out_Count();
        }
    ...
    Runnable dbUserDataRunnable = new Runnable() {
        @Override
        public void run() {
            DB_UserData();
        }
    ...
    public void DB_Get_Out_Count() {
        ...
        try {
            ...
            handler.sendEmptyMessage(GET_OUT_COUNT_FINISH);
        } catch (Exception e) {
            Log.e("DB_Get_Out_Count", e.toString());
        }
    }
    ...
    public void DB_UserData() {
        ...
        try {
            ...
            handler.sendEmptyMessage(DB_USER_DATA);
        } catch (Exception e) {
            Log.e("DB_UserData", e.toString());
        }
    }
