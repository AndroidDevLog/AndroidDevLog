...
import static com.iosdevlog.a187customlistviewsinglechildfromwebservice.Constrant.DONE;
import static com.iosdevlog.a187customlistviewsinglechildfromwebservice.Constrant.MESSAGE;
import static com.iosdevlog.a187customlistviewsinglechildfromwebservice.Constrant.TAG;
...
public class MainActivity extends ListActivity {
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (tag.equals(DONE)) {
                setListAdapter(new ListViewAct(MainActivity.this, list));
            } else {
                Log.e(tag, message);
